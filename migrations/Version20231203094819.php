...
final class Version20231203094819 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__shopping_cart AS SELECT id, user_id_id, state FROM shopping_cart');
        ...
        $this->addSql('INSERT INTO shopping_cart (id, user_id_id, state) SELECT id, user_id_id, state FROM __temp__shopping_cart');
